...
(function() {
  ...
  class PackageProtectionClientShopifyFreeTheme extends PackageProtectionClientBasic {
    ...
    async refreshWidget() {
      ...
      let subTotal = document.querySelectorAll(".totals__total-value, .totals, .cart-preview__total-price-value");
  ...
  class PackageProtectionClientUniversalTheme extends PackageProtectionClientBasic {
    ...
    getInsertionPointSelectors() {
      return [
        ...
        // Xclusive
        // {selector: 'safe-sticky button[name="checkout"]', insertPosition: 'before', }, // Impact
  ...
  class PackageProtectionClientImpactTheme extends PackageProtectionClientBasic {
    static shouldUse() {
      return checkTheme(impactThemes);
    }
    getInsertionPointSelectors() {
      return [
        { selector: 'button[name="checkout"][type="submit"]', insertPosition: "before" }
      ];
    }
    // theme support
    async refreshWidget() {
      console.log("impact-01");
      const subtotalSelector = [
        ".cart-form__totals",
        'button[type="submit"][name="checkout"]',
        'div[slot="footer"]'
  ...
  async function packageProtection() {
    ...
    const clients = [
      ...
      PackageProtectionClientImpactTheme,
