...
> extends Omit<
   ...
   * <description>Add the `~/shopify-session-storage-prisma` package to use the Prisma session storage.</description>
   * ```ts
   ...
   *
   * @defaultValue `LATEST_API_VERSION` from `~/shopify-app-remix`
   *
   * @example
