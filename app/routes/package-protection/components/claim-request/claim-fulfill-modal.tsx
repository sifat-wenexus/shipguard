...
// {
//   REFOUND_BY_AMOUNT_LINE_ITEM = 'REFOUND_BY_AMOUNT_LINE_ITEM',
//   REFOUND_BY_AMOUNT = 'REFOUND_BY_AMOUNT',
//   REORDER = 'REORDER',
// }
...
const ClaimFulfillModal = ({
  ...
  const { taxable, taxRate, taxPercentage, taxTitle } = fulfillmentLineItems[0];
